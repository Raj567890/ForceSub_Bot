...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Raj567890/ForceSub_Bot)

### Deploy in vps
- Clone this repo
```
git clone https://github.com/Raj567890/ForceSub_Bot
```
- Change directory
```
cd ForceSub_Bot
